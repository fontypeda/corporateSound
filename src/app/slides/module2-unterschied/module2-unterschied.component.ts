...
@Component({
  selector: 'app-module2-unterschied',
  standalone: true,
  imports: [CommonModule, ChartModule],
  templateUrl: './module2-unterschied.component.html',
  styleUrl: './module2-unterschied.component.scss',
})
export class Module2UnterschiedComponent {
  currentViewIndex = 0;
  totalViews = 4;
